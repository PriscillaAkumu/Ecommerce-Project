    ...
    <Box className='desc-container'>
      <Grid container sx={{ padding: '40px' }}>
        <Grid item xs={12}>
          ...
          >
            <Typography className='title' variant='subtitle1' color='#000'>
              Description
            </Typography>
            <Typography className='title' variant='subtitle1' color='#9F9F9F'>
              Additional Information
            </Typography>
            <Typography className='title' color='#9F9F9F'>
              Reviews [5]
            </Typography>
          </Stack>
        </Grid>
