...
export default function LoginForm() {
  ...
  return (
    <>
      {!isAuthenticated && (
        <Box>
          <Typography sx={{ display: { xs: 'block', md: 'block' } , fontWeight:"600",fontSize:"36px",lineHeight:"54px" }}>
            Log in
          </Typography>

          <form onSubmit={handleSubmit(onSubmit)} noValidate>
            <Stack>
              <Typography mb={2} mt={2} sx={{fontSize:"16px", fontWeight:"400", lineHeight:"24px"}}>
            ...
            <Stack direction='row' alignItems='center'>
              ...
              <Typography sx={{fontSize:"16px", fontWeight:"400", lineHeight:"24px"}}>Remember me</Typography>
            </Stack>
